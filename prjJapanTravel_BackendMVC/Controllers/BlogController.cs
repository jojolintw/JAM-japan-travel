    ...
    public class BlogController : Controller
    {
       ...
       .AsQueryable(); // 使用 IQueryable 以便后续可以动态添加条件
            ...
            var articledatas = datas.Select(m => new ArticleMainViewModel
            {
                ...
                會員編號 = m.MemberId,
                文章發布時間 = m.ArticleLaunchtime, 
                文章狀態 = m.ArticleStatusnumberNavigation.StatusName,
                文章標題 = m.ArticleTitle,
                文章最後更新時間 = m.ArticleLastupatetime, 
        ...
        {
            am.ArticleLaunchtime = DateTime.Now;
            am.ArticleLastupatetime = DateTime.Now;
        ...
        public IActionResult Edit(ArticleMainViewModel amvm)
        {
            ...
            //}
            data.ArticleLastupatetime = DateTime.Now;
